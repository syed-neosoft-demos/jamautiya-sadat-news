...
const WhatsAppIcon = () => (
  <svg className="w-9 h-9 fill-current text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const sections = [
  {
    ...
    content: (
      <>
        We do <strong>not collect, store, or share</strong> any personal information from group members. Your phone number and any personal data shared in the group remain private and are not used for any other purpose.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Each member is <strong>fully responsible</strong> for the content they share. We do not endorse or take responsibility for any hateful, offensive, or harmful content shared within the group. Members must adhere to community guidelines and show respect to others.
      </>
    ),
  },
  {
    ...
    content: (
      <>
        Sharing <strong>hateful content</strong> against individuals or the community is strictly prohibited. Any member found violating this rule will be held responsible.
      </>
    ),
    prohibited: [
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? "0 4px 24px rgba(26,122,74,0.10)" : "0 1px 3px rgba(0,0,0,0.06)",
      }}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f4f9f6", fontFamily: "'Nunito', sans-serif", color: "#1c2e22" }}>
      <style>{`
      ...
      >
        {/* WhatsApp icon */}
        <div style={fadeStyle(0)} className="inline-flex items-center justify-center w-16 h-16 rounded-2xl shadow-lg mb-6"
          style2={{ background: "linear-gradient(135deg, #25d366, #128c7e)", ...fadeStyle(0) }}>
          <div
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl shadow-lg mb-6"
            style={{ background: "linear-gradient(135deg, #25d366, #128c7e)", ...fadeStyle(0) }}
          >
            <WhatsAppIcon />
          </div>
        </div>

        <h1 className="amiri text-white text-4xl md:text-5xl font-bold leading-tight" style={fadeStyle(100)}>
          JAMAUTIYA SADAT NEWS
        </h1>
        <p className="text-lg mt-2 tracking-widest uppercase font-semibold" style={{ color: "#86efac", ...fadeStyle(200) }}>
          WhatsApp Group
        </p>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Intro */}
        <p className="text-base md:text-lg text-gray-600 text-center leading-relaxed mb-10" style={fadeStyle(100)}>
          Welcome to the{" "}
          <strong style={{ color: "#1a7a4a" }}>JAMAUTIYA SADAT NEWS</strong>{" "}
          WhatsApp Group. We are committed to maintaining your privacy and ensuring a safe space for sharing news relevant to our hometown. Please review the following policy to understand how we handle your information.
        </p>
        ...
        {/* Divider */}
        <div className="divider-ornament mb-10" style={{ color: "#86efac", fontSize: "1.125rem" }}>
          <span>✦</span>
        </div>
        ...
        >
          <p className="text-base leading-relaxed">
            ...
            <strong>agree to adhere</strong> to this Privacy Policy. Thank you for helping us maintain a respectful and informative space for our hometown news.
          </p>
        </div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold mb-1" style={{ color: "#92600a" }}>NOTE</p>
              <p className="text-sm leading-relaxed" style={{ color: "#78450a" }}>
                If you have any questions or concerns about this policy, please reach out to the{" "}
      ...
      <footer className="text-center py-8 text-gray-400 text-xs border-t border-gray-200 mt-4">
        © 2024 JAMAUTIYA SADAT NEWS WhatsApp Group &nbsp;·&nbsp; All rights reserved
      </footer>
    </div>
  );
}